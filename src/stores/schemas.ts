...
export const capabilitiesSchema = z.record(z.string(), z.number().int().gte(1))
...
export const datumSchema = z.object({ lat: z.number(), long: z.number(), height: z.number() })
...
export const stateDefaults: State = {
  ...
  gps_percentage: 0.0,
  is_charging: false,
  pose: { heading: 0, heading_accuracy: 0, heading_valid: false, pos_accuracy: 0, x: 0, y: 0 },
}
